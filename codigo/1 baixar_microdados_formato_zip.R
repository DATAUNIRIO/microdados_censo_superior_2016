...
# refazendo para aqueles que falharam
nome_arquivos<-nome_arquivos[c(15,17,18,22,24)]
j<-c(2009,2012,2016,2018)

for (i in 1:5) {
  url <- nome_arquivos[i]
  local<-paste0("C:/Users/steve/OneDrive/Desktop/microdados_INEP/microdados_educacao_superior_",j[i],".zip")
  Sys.sleep(10)
  download.file(url, local, mode="wb")  
  print(j[i])
}  
